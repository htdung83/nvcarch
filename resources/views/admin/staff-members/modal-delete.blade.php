    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Dịch vụ <span class="fw-bold text-danger">{{ $item->name }}</span> sẽ bị xóa và không hiển thị trên web nữa.</p>
                <p>Bạn có muốn tiếp tục?</p>
            </div>
            <form action="{{ route('admin.staff-members.destroy', $item) }}" method="post">
                @csrf
                @method('DELETE')
